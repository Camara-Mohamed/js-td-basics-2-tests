...
if (height) {
    console.log(`La variable height (${height}) est définie`);
} else {
    console.log(`La variable height (${height}) n'est PAS définie`);
}
...
if (height2) {
    console.log(`Cette variable (${height2}) contient bien une valeur non nulle`);
} else {
    console.log(`Cette variable (${height2}) est nulle ou non définie`);
}
...
if (23 === '23') {
    console.log(`J'ai testé si 23 était égal à '23' avec vérifier le type. L'opérateur que j'ai utilisé n'a pas opéré une conversion de type`);
} else {
    console.log(`La conversion de type n'est pas possible`);
}
