...
let hour = prompt(`Donne-moi une heure :`);
let minute = prompt(`Donne-moi une minute :`);
let second = prompt(`Donne-moi une seconde :`);
...
/*
console.log(`La nouvelle heure vaut ${hour}. La nouvelle minute vaut ${minute}. La nouvelle seconde vaut ${second}.`);*/
